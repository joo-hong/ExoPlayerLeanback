 ...
 */
package com.nemustech.exoplayerleanback.util;
...
import com.nemustech.exoplayerleanback.ExoplayerActivity.RendererBuilder;
import com.nemustech.exoplayerleanback.ExoplayerActivity.RendererBuilderCallback;
import com.google.android.exoplayer.upstream.BufferPool;
import com.google.android.exoplayer.upstream.DataSource;
import com.google.android.exoplayer.upstream.DefaultBandwidthMeter;
import com.google.android.exoplayer.upstream.HttpDataSource;
import com.google.android.exoplayer.util.ManifestFetcher.ManifestCallback;
import com.nemustech.exoplayerleanback.ExoplayerActivity;
 ...
 */
/* package */ public class DashVodRendererBuilder implements RendererBuilder,
    ManifestCallback<MediaPresentationDescription> {

  private static final int BUFFER_SEGMENT_SIZE = 64 * 1024;
  private static final int VIDEO_BUFFER_SEGMENTS = 200;
  private static final int AUDIO_BUFFER_SEGMENTS = 60;
    private static final String TAG = "DashVodRendererBuilder";

    private final ExoplayerActivity playerActivity;
  ...
  public DashVodRendererBuilder(ExoplayerActivity playerActivity, String userAgent, String url,
      String contentId) {
    ...
    this.contentId = contentId;
      ...
      Log.e(TAG, "DashVodRendererBuilder");
  }
