...
//        mRowsAdapter.add(new ListRow(gridHeader, gridRowAdapter));
        ...
        HeaderItem urlHeader = new HeaderItem(i+1, "ExoPlayer Sample", null);
        GridItemPresenter gridPresenter = new GridItemPresenter();
        ArrayObjectAdapter gridRowAdapter2 = new ArrayObjectAdapter(gridPresenter);
        gridRowAdapter2.add("Google glass");
        gridRowAdapter2.add("Google play");
        gridRowAdapter2.add("Super Speed Way");
        mRowsAdapter.add(new ListRow(urlHeader, gridRowAdapter2));
...
//                            .show();
                    ...
                    if(item.toString().equals("Google glass")) {
                        intent = new Intent(getActivity(), ExoplayerActivity.class)
                                ...
                                .putExtra("content_id", "bf5bb2419360daf1")
                                .putExtra("content_type", 0);
                    }
                    else if(item.toString().equals("Google play")) {
                        intent = new Intent(getActivity(), ExoplayerActivity.class)
                                .setData(Uri.parse("http://www.youtube.com/api/manifest/dash/id/3aa39fa2cc27967f/source/youtube?"
                                ...
                                .putExtra("content_id", "3aa39fa2cc27967f")
                                .putExtra("content_type", 0);
                    }
                    else if (item.toString().equals("Super Speed Way")) {
                        intent = new Intent(getActivity(), ExoplayerActivity.class)
                                .setData(Uri.parse("http://playready.directtaps.net/smoothstreaming/SSWSS720H264/SuperSpeedway_720.ism"))
                                .putExtra("content_id", "uid:ss:superspeed")
                                .putExtra("content_type", 1);
                    }
